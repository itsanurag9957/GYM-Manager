  ...
  <section class="mysection">
    ...
    <div class="content-container">
      ...
      <div class="table-container">
        ...
        <form action="update_admin_done.php" method="post">
          <table>
            <tr>
              <td>Enter OTP sent on :- <?php echo $_SESSION['admin_email'] ?> </td>
              <td><input type="number" name="otpadmin" id="" class="form-control"></td>
            </tr>
          </table>
