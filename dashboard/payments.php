        ...
        <table class="table" border="1">
          ...
          <?php 
            if(isset($_SESSION["payment"])){
              $counter=1;
              $query="select u.userid , u.name ,e.expiry_date , p.validity , p.amount , u.email , u.mobile from users u JOIN enroll e ON u.userid=e.userid JOIN plan p ON e.pid=p.pid; ";
              if($res=pg_query($dbcon,$query)){
                ...
                echo "
                  ...
                  <td>".$row[4]." rupees</td>
                  <td>".$row[5]."</td>
                  <td><input type='submit' class='btn btn-primary' value='Add Payment'/>
